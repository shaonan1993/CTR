...
experiment_name=t0-large-vae-pseudo_label_no_prompt_${shot_num}
commitment_cost=0.1
...
load_ckpt=./exp_dir/t0_pretrain_vae_large_384_32_step20000_des_no_prompt_128_10_0.1_pipe/t0-large-vae-pipe/5000

export CUDA_VISIBLE_DEVICES=0

python -m torch.distributed.launch  --nproc_per_node=1 --master_port=56483  fewshot_t0_VAEmixin_pseudo_label_no_prompt.py \
