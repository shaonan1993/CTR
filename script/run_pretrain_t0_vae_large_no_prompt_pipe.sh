...
task_set="t0"
load_ckpt=./exp_dir/t0_pretrain_vae_large_384_32_batch256_8_step10000_no_prompt_0.1/t0-large-vae/10000
tok_load_dir='./pretrained_models/t5-large-lm-adapt'
experiment_name='t0-large-vae-pipe'
commitment_cost=0.1
save_dir=./exp_dir/t0_pretrain_vae_large_384_32_batch256_8_step10000_no_prompt_${commitment_cost}_pipe
