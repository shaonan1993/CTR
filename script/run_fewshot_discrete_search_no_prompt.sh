...
experiment_name=t0-large-vae-discrete-search_loss_no_prompt_${shot_num}_${FEWSHOT_SEED}
commitment_cost=0.1
...
python -m torch.distributed.launch  --nproc_per_node=1 --master_port=56420  fewshot_t0_VAEmixin_discrete_search_loss.py \
